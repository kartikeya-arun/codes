...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand)>0:# As long as there are still letters left in the hand:
        ...
        #print(disphand)# Display the hand
        ...
        if word=='.':# If the input is a single period:
        ...
        elif isValidWord(word, hand, wordList)!=True:# Otherwise (the input is not a single period):
            ...
            print('"'+word+'"'+'earned '+str(getWordScore(word, n))+' points. Total: ',score)# Tell the user how many points the word earned, and the updated total score, in one line followed by a blank line
...
def playGame(wordList):
    ...
    """
    while True:
        ch=str(input('Enter n to deal a new hand, r to replay the last hand, or e to end game: '))
        if ch=='e':
            break
        elif ch=='n':
